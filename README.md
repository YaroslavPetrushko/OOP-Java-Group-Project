...
| Пошук книги за читачем                | ✅    |
| Фільтрація книг за жанром             | ✅    |
| Фільтрація книг за роком              | ✅    |
| Пошук автора за іменем                | ✅    |
| Пошук \ фільтрація авторів за країною | ✅    |
| Пошук \ фільтрація авторів за роком   | ✅    |
| Пошук читача за іменем                | ✅    |
| Пошук читача за поштою                | ✅    |
| Пошук читача за номером телефону      | ✅    |
| Фільтрація читачів за датою           | ✅    |
| Пошук позик за ID                     | ✅    |
| Пошук позик за назвою книги           | ✅    |
| Пошук позик за іменем читача          | ✅    |
| Фільтрація позик за статусом          | ✅    |
| Фільтрація позик за датою             | ✅    |
...
| 10.04–13.05 | **Step 8: полірування UI, діалоги, валідація**       | 🔄 Поточний  |
| 10.05–17.05 | Тестування, виправлення помилок                      | ⬜            |
| 13.05–20.05 | Документація, підготовка до захисту                  | ⬜            |
