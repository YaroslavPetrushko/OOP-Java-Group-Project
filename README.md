...
| 20.03–27.03 | Проєктування БД, schema.sql, seed.sql | ✅ Виконано |
| 24.03–26.03 | Step 1–2: структура Maven-проєкту, підключення до БД | ✅ Виконано |
| 27.03–28.03 | Step 3: перше JavaFX-вікно | ✅ Виконано |
| 29.03–31.03 | **Step 4: базовий UI — навігація, TabPane, TableView** | 🔄 Поточний |
| 01.04–05.04 | **Step 5: Model + DAO + перший живий CRUD (Books)** | ⬜ Наступний |
| 06.04–12.04 | Step 6: CRUD для Authors, Readers, Loans | ⬜ |
| 13.04–19.04 | Step 7: пошук та фільтрація (PreparedStatement) | ⬜ |
| 20.04–30.04 | Step 8: полірування UI, діалоги, валідація | ⬜ |
| 01.05–07.05 | Тестування, виправлення помилок | ⬜ |
| 08.05–17.05 | Документація, підготовка до захисту | ⬜ |
